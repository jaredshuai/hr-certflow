...
from app.services.review_service import add_calendar_months
...
def test_add_months_cross_year() -> None:
    assert add_calendar_months(date(2026, 11, 10), 3) == date(2027, 2, 10)
...
def test_add_months_twelve() -> None:
    assert add_calendar_months(date(2026, 6, 15), 12) == date(2027, 6, 15)


def test_add_months_zero() -> None:
    assert add_calendar_months(date(2026, 3, 15), 0) == date(2026, 3, 15)


def test_add_months_feb_29_leap_year() -> None:
    assert add_calendar_months(date(2028, 2, 29), 12) == date(2029, 2, 28)


def test_add_months_large_value() -> None:
    assert add_calendar_months(date(2026, 1, 15), 24) == date(2028, 1, 15)
